...
import { C, fmt, LOW_THR, TODAY_ES } from "../../utils/constants";
...
export function DashboardScreen({ goTo, onBell, notifCount, onShowAllNotif }:{
  goTo:(s:Screen)=>void; onBell:()=>void; notifCount:number; onShowAllNotif:()=>void;
}) {
  ...
  const { efectivoTotal, tarjetaTotal, total } = AnalyticsService.getAcumuladoDiario(orders);
